...
/*串口3发送缓冲区*/
extern u8 TxBuffer3[MAX_USART_TXBUFLEN];
/*串口3接收缓冲区*/
extern u8 RxBuffer3[MAX_USART_RXBUFLEN];
/*串口3接收缓冲区*/
extern u8 RX_USART3_BUFF[MAX_USART_RXBUFLEN];
/*串口3接收标志位*/
extern u8 Rx_USART3_Flags;
/*串口3接收长度*/
extern u8 Rx_USART3_Len;
